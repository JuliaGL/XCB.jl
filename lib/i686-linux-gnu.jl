...
function Base.getproperty(x::Ptr{__JL_Ctag_32}, f::Symbol)
    ...
    f === :group_rtrn && return Ptr{Ptr{xcb_xkb_mod_def_t}}(x + 36)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{xcb_xkb_get_kbd_by_name_replies_t}, f::Symbol)
    f === :types && return Ptr{__JL_Ctag_31}(x + 0)
    f === :compat_map && return Ptr{__JL_Ctag_32}(x + 76)
    f === :indicator_maps && return Ptr{__JL_Ctag_33}(x + 116)
    f === :key_names && return Ptr{__JL_Ctag_34}(x + 152)
    f === :geometry && return Ptr{__JL_Ctag_35}(x + 244)
    return getfield(x, f)
end
...
function xcb_xkb_get_kbd_by_name_replies_t(types::__JL_Ctag_31, compat_map::__JL_Ctag_32, indicator_maps::__JL_Ctag_33, key_names::__JL_Ctag_34, geometry::__JL_Ctag_35)

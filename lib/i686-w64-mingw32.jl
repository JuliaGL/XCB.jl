...
function Base.getproperty(x::Ptr{xcb_xkb_get_kbd_by_name_replies_t}, f::Symbol)
    f === :types && return Ptr{__JL_Ctag_9}(x + 0)
    f === :compat_map && return Ptr{__JL_Ctag_10}(x + 76)
    f === :indicator_maps && return Ptr{__JL_Ctag_11}(x + 116)
    f === :key_names && return Ptr{__JL_Ctag_12}(x + 152)
    f === :geometry && return Ptr{__JL_Ctag_13}(x + 244)
    return getfield(x, f)
end
...
function xcb_xkb_get_kbd_by_name_replies_t(types::__JL_Ctag_9, compat_map::__JL_Ctag_10, indicator_maps::__JL_Ctag_11, key_names::__JL_Ctag_12, geometry::__JL_Ctag_13)
